...
<head>
    ...
    <meta property="og:title" content="@yield('title', 'Instructor Portal') - {{ config('app.name', 'EnrollAssess') }}">
    <meta property="og:description" content="@yield('description', 'EnrollAssess Instructor Portal - Manage interviews and applicant assessments')">
    ...
    <!-- Admin CSS Bundle (shared with instructor) -->
