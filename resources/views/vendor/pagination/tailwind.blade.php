                        ...
                        @if (is_string($element))
                            @php
                                ...
                                if (is_array($prev) && is_array($next)) {
                                    $lastPageOfPrev = array_key_last($prev);
                                    $firstPageOfNext = array_key_first($next);
                                    $gapSize = $firstPageOfNext - $lastPageOfPrev - 1;
                                    
                                    if ($gapSize <= 2 && $gapSize > 0) {
                                         $showEllipsis = false;
                                         for ($p = $lastPageOfPrev + 1; $p < $firstPageOfNext; $p++) {
                                             $gapLinks[$p] = $paginator->url($p);
                                         }
                                    }
                                }
                            @endphp
