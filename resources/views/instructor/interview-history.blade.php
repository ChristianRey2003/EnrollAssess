...
<head>
    ...
    <title>Interview History - Instructor Portal</title>
...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('instructor.interview-history') }}" class="text-blue-600 font-medium">Interview History</a>
                    <a href="{{ route('instructor.guidelines') }}" class="text-gray-600 hover:text-gray-900">Guidelines</a>
    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">📋 Interview History</h1>
            <p class="mt-2 text-gray-600">Review your completed interview evaluations and performance statistics</p>
        </div>
        ...
        <div class="bg-white shadow rounded-lg">
                            ...
                            @foreach($completedInterviews as $interview)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-2 w-16 bg-gray-200 rounded-full h-2">
                                                <div class="bg-blue-600 h-2 rounded-full" style="width: {{ $interview->overall_score ?? 0 }}%"></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <button class="text-blue-600 hover:text-blue-900" onclick="viewInterviewDetails({{ $interview->interview_id }})">
                                            View Details
                                        </button>
                                    </td>
                                </tr>
            ...
            @else
                <div class="px-6 py-8 text-center">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('instructor.applicants') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
